...
const mapper = {
  ...
  'dall-e-3': DEPLOY_NAME_DALL_E_3,
};

const apiVersion = "2023-08-01-preview"
const dallApiVersion = "2023-12-01-preview"
...
async function handleRequest(request) {
  ...
  if (isDall) {
    fetchAPI = `https://${resourceName}.openai.azure.com/openai/deployments/${deployName}/${path}?api-version=${dallApiVersion}`
  }
